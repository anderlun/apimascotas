    ...
    <div className="w-full h-screen flex justify-center items-center bg-blue-200">
      <div className="w-[400px] h-[90%] bg-blue-800 p-6 rounded-[25px]">
        <div className="flex flex-col items-end">
          ...
          <Link
            href="/registrarpet"
            className="flex justify-center items-center rounded-full h-10 w-32 bg-green-500 hover:bg-green-400 text-white gap-1"
          >
          ...
          <Link
              href="/mascotaspormunicipio" // Ajusta la ruta según la estructura de tu proyecto
              className="flex justify-center items-center rounded-full h-10 w-32 bg-green-500 hover:bg-green-400 text-white gap-1">
              <p className="text-2xl">+</p>
              <p className="font-bold">Mascota por Municipio</p>
            </Link>
