...
const handleSubmit = async (event) => {
    ...
    try {
        ...
        formData.append('municipio_id', pet.municipio_id); // Agrega municipio_id aquí
  ...
  return (
    <div>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-3'>
            ...
            <select className='px-4 py-[14px] rounded-[50px] bg-white bg-opacity-60 outline-none' name='municipio_id' value={pet.municipio_id} onChange={handleChange} >
                <option value="" className='text-gray-500 p-2'>Seleccione municipio...</option>
                <option value="1" className='text-black p-2'>Pitalito</option>
                <option value="2" className='text-black p-2'>Plata</option>
            </select>
